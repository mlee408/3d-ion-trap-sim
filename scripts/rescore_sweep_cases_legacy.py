...
Usage:
    python ../../../scripts/rescore_sweep_cases_legacy.py --case-start 0 --case-end 49

NOTE: this is the original scorer (pre-transport-barrier update).
  Spread threshold: 0.5 MHz (not 5 MHz)
  No transport barrier term
  No Hessian multiplier
See rescore_sweep_cases.py for the current version matching automate.py.
"""
